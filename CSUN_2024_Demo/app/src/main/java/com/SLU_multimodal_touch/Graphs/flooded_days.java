...
public class flooded_days extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.flooded_days);
        ...
        if (orientation == Configuration.ORIENTATION_LANDSCAPE) {
            // In landscape
            mv.setImageResource(R.drawable.flooded_days);
        } else {
            // In portrait
            mv.setImageResource(R.drawable.flooded_days);
        }
...
//                grtv.setText("You swiped up with " + fingers + " finger(s).");
                if (fingers == 1) {
                    ...
                    Intent back_to_graph_selector = new Intent(flooded_days.this, GraphSelector.class);
            ...
            public void run() {
                ...
                if (sfg.finger_count == 1){
                    ...
                    if (f0_index != -1) {
                        ...
                        // setting text to speech for flooded_days
                        if (X_screenPercent > 0.31 && X_screenPercent < 0.68 && Y_screenPercent < 0.06 && Y_screenPercent > 0.02){
                            if (!hasSpoken) {
                                tts.speak("Title: Frequency of Monthly Flooded Days! We documented the number of days that experienced floods for six months in 2021. The bar graph presented below illustrates the distribution of rainy days across each month. Refer to the graph below to address the following questions.", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.01 && X_screenPercent < 0.03 && Y_screenPercent < 0.63 && Y_screenPercent > 0.33){
                            if (!hasSpoken) {
                                tts.speak("Y-axis title: Number of Days", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.47 && X_screenPercent < 0.55 && Y_screenPercent < 0.98 && Y_screenPercent > 0.95){
                            if (!hasSpoken) {
                                tts.speak("X-axis title: Months", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.11 && X_screenPercent < 0.19 && Y_screenPercent < 0.94 && Y_screenPercent > 0.90){
                            if (!hasSpoken) {
                                tts.speak("April", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.26 && X_screenPercent < 0.33 && Y_screenPercent < 0.94 && Y_screenPercent > 0.90){
                            if (!hasSpoken) {
                                tts.speak("May", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.40 && X_screenPercent < 0.47 && Y_screenPercent < 0.94 && Y_screenPercent > 0.90){
                            if (!hasSpoken) {
                                tts.speak("June", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.55 && X_screenPercent < 0.62 && Y_screenPercent < 0.94 && Y_screenPercent > 0.90){
                            if (!hasSpoken) {
                                tts.speak("July", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.69 && X_screenPercent < 0.76 && Y_screenPercent < 0.94 && Y_screenPercent > 0.90){
                            if (!hasSpoken) {
                                tts.speak("August", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.83 && X_screenPercent < 0.91 && Y_screenPercent < 0.94 && Y_screenPercent > 0.90){
                            if (!hasSpoken) {
                                tts.speak("September", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.04 && X_screenPercent < 0.95 && Y_screenPercent < 0.89 && Y_screenPercent > 0.86){
                            if (!hasSpoken) {
                                tts.speak("0", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.04 && X_screenPercent < 0.95 && Y_screenPercent < 0.81 && Y_screenPercent > 0.78){
                            if (!hasSpoken) {
                                tts.speak("2", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.04 && X_screenPercent < 0.95 && Y_screenPercent < 0.73 && Y_screenPercent > 0.70){
                            if (!hasSpoken) {
                                tts.speak("4", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.04 && X_screenPercent < 0.95 && Y_screenPercent < 0.65 && Y_screenPercent > 0.62){
                            if (!hasSpoken) {
                                tts.speak("6", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.04 && X_screenPercent < 0.95 && Y_screenPercent < 0.57 && Y_screenPercent > 0.54){
                            if (!hasSpoken) {
                                tts.speak("8", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.04 && X_screenPercent < 0.95 && Y_screenPercent < 0.49 && Y_screenPercent > 0.46){
                            if (!hasSpoken) {
                                tts.speak("10", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.04 && X_screenPercent < 0.95 && Y_screenPercent < 0.42 && Y_screenPercent > 0.39){
                            if (!hasSpoken) {
                                tts.speak("12", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.04 && X_screenPercent < 0.95 && Y_screenPercent < 0.34 && Y_screenPercent > 0.31){
                            if (!hasSpoken) {
                                tts.speak("14", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.04 && X_screenPercent < 0.95 && Y_screenPercent < 0.26 && Y_screenPercent > 0.23){
                            if (!hasSpoken) {
                                tts.speak("16", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.04 && X_screenPercent < 0.95 && Y_screenPercent < 0.18 && Y_screenPercent > 0.15){
                            if (!hasSpoken) {
                                tts.speak("18", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.04 && X_screenPercent < 0.95 && Y_screenPercent < 0.10 && Y_screenPercent > 0.06){
                            if (!hasSpoken) {
    ...
    public void logger(String file_name) throws IOException {
        ...
        final Runnable runnable = new Runnable() {
            ...
            public void run() {
                ...
                if (ContextCompat.checkSelfPermission(flooded_days.this,Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(flooded_days.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},1);
                }
                else {
