...
public class fruit_preference extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fruit_preference);
        ...
        if (orientation == Configuration.ORIENTATION_LANDSCAPE) {
            // In landscape
            mv.setImageResource(R.drawable.fruit_preference);
        } else {
            // In portrait
            mv.setImageResource(R.drawable.fruit_preference);
        }
...
//                grtv.setText("You swiped up with " + fingers + " finger(s).");
                if (fingers == 1) {
                    ...
                    Intent back_to_graph_selector = new Intent(fruit_preference.this, GraphSelector.class);
            ...
            public void run() {
                ...
                if (sfg.finger_count == 1){
                    ...
                    if (f0_index != -1) {
                        ...
                        // setting text to speech for fruit_preference
                        if (X_screenPercent > 0.32 && X_screenPercent < 0.67 && Y_screenPercent < 0.06 && Y_screenPercent > 0.02){
                            if (!hasSpoken) {
                                tts.speak("Title: Children's Preference for Fruits! A teacher decided to delight her students with fruits and documented their preferences for three different types. The accompanying right oriented bar graph llustrates the number of students who favored each of the three  types of fruits in her classroom. Refer to the graph below to respond to the questions.", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.004 && X_screenPercent < 0.02 && Y_screenPercent < 0.63 && Y_screenPercent > 0.35){
                            if (!hasSpoken) {
                                tts.speak("Y-axis title: Types of Fruits", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.44 && X_screenPercent < 0.63 && Y_screenPercent < 0.96 && Y_screenPercent > 0.93){
                            if (!hasSpoken) {
                                tts.speak("X-axis title: Number of Children", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.03 && X_screenPercent < 0.09 && Y_screenPercent < 0.78 && Y_screenPercent > 0.66){
                            if (!hasSpoken) {
                                tts.speak("Apples", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.03 && X_screenPercent < 0.09 && Y_screenPercent < 0.53 && Y_screenPercent > 0.41){
                            if (!hasSpoken) {
                                tts.speak("Oranges", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.03 && X_screenPercent < 0.09 && Y_screenPercent < 0.28 && Y_screenPercent > 0.15){
                            if (!hasSpoken) {
                                tts.speak("Kiwis", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.10 && X_screenPercent < 0.11 && Y_screenPercent < 0.91 && Y_screenPercent > 0.09){
                            if (!hasSpoken) {
                                tts.speak("0", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.16 && X_screenPercent < 0.17 && Y_screenPercent < 0.91 && Y_screenPercent > 0.09){
                            if (!hasSpoken) {
                                tts.speak("2", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.23 && X_screenPercent < 0.24 && Y_screenPercent < 0.91 && Y_screenPercent > 0.09){
                            if (!hasSpoken) {
                                tts.speak("4", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.30 && X_screenPercent < 0.31 && Y_screenPercent < 0.91 && Y_screenPercent > 0.09){
                            if (!hasSpoken) {
                                tts.speak("6", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.36 && X_screenPercent < 0.38 && Y_screenPercent < 0.91 && Y_screenPercent > 0.09){
                            if (!hasSpoken) {
                                tts.speak("8", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.42 && X_screenPercent < 0.45 && Y_screenPercent < 0.91 && Y_screenPercent > 0.09){
                            if (!hasSpoken) {
                                tts.speak("10", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.49 && X_screenPercent < 0.51 && Y_screenPercent < 0.91 && Y_screenPercent > 0.09){
                            if (!hasSpoken) {
                                tts.speak("12", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.56 && X_screenPercent < 0.58 && Y_screenPercent < 0.91 && Y_screenPercent > 0.09){
                            if (!hasSpoken) {
                                tts.speak("14", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.62 && X_screenPercent < 0.65 && Y_screenPercent < 0.91 && Y_screenPercent > 0.09){
                            if (!hasSpoken) {
                                tts.speak("16", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.69 && X_screenPercent < 0.71 && Y_screenPercent < 0.91 && Y_screenPercent > 0.09){
                            if (!hasSpoken) {
                                tts.speak("18", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.76 && X_screenPercent < 0.78 && Y_screenPercent < 0.91 && Y_screenPercent > 0.09){
                            if (!hasSpoken) {
                                tts.speak("20", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.82 && X_screenPercent < 0.85 && Y_screenPercent < 0.91 && Y_screenPercent > 0.09){
                            if (!hasSpoken) {
                                tts.speak("22", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.89 && X_screenPercent < 0.92 && Y_screenPercent < 0.91 && Y_screenPercent > 0.09){
                            if (!hasSpoken) {
                                tts.speak("24", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.96 && X_screenPercent < 0.98 && Y_screenPercent < 0.91 && Y_screenPercent > 0.09){
                            if (!hasSpoken) {
    ...
    public void logger(String file_name) throws IOException {
        ...
        final Runnable runnable = new Runnable() {
            ...
            public void run() {
                ...
                if (ContextCompat.checkSelfPermission(fruit_preference.this,Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(fruit_preference.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},1);
                }
                else {
