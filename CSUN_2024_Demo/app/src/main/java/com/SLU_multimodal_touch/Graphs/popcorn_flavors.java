...
public class popcorn_flavors extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.popcorn_flavors);
        ...
        if (orientation == Configuration.ORIENTATION_LANDSCAPE) {
            // In landscape
            mv.setImageResource(R.drawable.popcorn_flavors);
        } else {
            // In portrait
            mv.setImageResource(R.drawable.popcorn_flavors);
        }
...
//                grtv.setText("You swiped up with " + fingers + " finger(s).");
                if (fingers == 1) {
                    ...
                    Intent back_to_graph_selector = new Intent(popcorn_flavors.this, GraphSelector.class);
            ...
            public void run() {
                ...
                if (sfg.finger_count == 1){
                    ...
                    if (f0_index != -1) {
                        ...
                        // setting text to speech for popcorn_flavors
                        if (X_screenPercent > 0.31 && X_screenPercent < 0.68 && Y_screenPercent < 0.06 && Y_screenPercent > 0.02){
                            if (!hasSpoken) {
                                tts.speak("Title: Children's Preference for Popcorn! A teacher decided to delight her students with popcorn and documented their preferences for three different flavors. The accompanying right oriented bar graph  illustrates the number of students who favored each of the three popcorn flavors in her classroom. Refer to the graph below to respond to the questions.", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.01 && X_screenPercent < 0.03 && Y_screenPercent < 0.61 && Y_screenPercent > 0.32){
                            if (!hasSpoken) {
                                tts.speak("Y-axis title: Popcorn Flavor", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.46 && X_screenPercent < 0.64 && Y_screenPercent < 0.96 && Y_screenPercent > 0.93){
                            if (!hasSpoken) {
                                tts.speak("X-axis title: Number of Children", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.04 && X_screenPercent < 0.12 && Y_screenPercent < 0.28 && Y_screenPercent > 0.15){
                            if (!hasSpoken) {
                                tts.speak("Caramel", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.04 && X_screenPercent < 0.12 && Y_screenPercent < 0.53 && Y_screenPercent > 0.41){
                            if (!hasSpoken) {
                                tts.speak("Butter", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.04 && X_screenPercent < 0.12 && Y_screenPercent < 0.79 && Y_screenPercent > 0.63){
                            if (!hasSpoken) {
                                tts.speak("Plain", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.13 && X_screenPercent < 0.14 && Y_screenPercent < 0.91 && Y_screenPercent > 0.08){
                            if (!hasSpoken) {
                                tts.speak("0", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.18 && X_screenPercent < 0.20 && Y_screenPercent < 0.91 && Y_screenPercent > 0.08){
                            if (!hasSpoken) {
                                tts.speak("2", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.24 && X_screenPercent < 0.26 && Y_screenPercent < 0.91 && Y_screenPercent > 0.08){
                            if (!hasSpoken) {
                                tts.speak("4", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.30 && X_screenPercent < 0.32 && Y_screenPercent < 0.91 && Y_screenPercent > 0.08){
                            if (!hasSpoken) {
                                tts.speak("6", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.36 && X_screenPercent < 0.38 && Y_screenPercent < 0.91 && Y_screenPercent > 0.08){
                            if (!hasSpoken) {
                                tts.speak("8", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.42 && X_screenPercent < 0.44 && Y_screenPercent < 0.91 && Y_screenPercent > 0.08){
                            if (!hasSpoken) {
                                tts.speak("10", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.48 && X_screenPercent < 0.50 && Y_screenPercent < 0.91 && Y_screenPercent > 0.08){
                            if (!hasSpoken) {
                                tts.speak("12", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.54 && X_screenPercent < 0.56 && Y_screenPercent < 0.91 && Y_screenPercent > 0.08){
                            if (!hasSpoken) {
                                tts.speak("14", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.60 && X_screenPercent < 0.62 && Y_screenPercent < 0.91 && Y_screenPercent > 0.08){
                            if (!hasSpoken) {
                                tts.speak("16", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.66 && X_screenPercent < 0.68 && Y_screenPercent < 0.91 && Y_screenPercent > 0.08){
                            if (!hasSpoken) {
                                tts.speak("18", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.72 && X_screenPercent < 0.74 && Y_screenPercent < 0.91 && Y_screenPercent > 0.08){
                            if (!hasSpoken) {
                                tts.speak("20", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.78 && X_screenPercent < 0.80 && Y_screenPercent < 0.91 && Y_screenPercent > 0.08){
                            if (!hasSpoken) {
                                tts.speak("22", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.84 && X_screenPercent < 0.86 && Y_screenPercent < 0.91 && Y_screenPercent > 0.08){
                            if (!hasSpoken) {
                                tts.speak("24", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.90 && X_screenPercent < 0.92 && Y_screenPercent < 0.91 && Y_screenPercent > 0.08){
                            if (!hasSpoken) {
                                tts.speak("26", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.96 && X_screenPercent < 0.98 && Y_screenPercent < 0.91 && Y_screenPercent > 0.08){
                            if (!hasSpoken) {
                                tts.speak("28", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        }
                        else {
    ...
    public void logger(String file_name) throws IOException {
        ...
        final Runnable runnable = new Runnable() {
            ...
            public void run() {
                ...
                if (ContextCompat.checkSelfPermission(popcorn_flavors.this,Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(popcorn_flavors.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},1);
                }
                else {
