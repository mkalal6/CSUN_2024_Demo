...
public class snowy_days extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.snowy_days);
        ...
        if (orientation == Configuration.ORIENTATION_LANDSCAPE) {
            // In landscape
            mv.setImageResource(R.drawable.snowy_days);
        } else {
            // In portrait
            mv.setImageResource(R.drawable.snowy_days);
        }
...
//                grtv.setText("You swiped up with " + fingers + " finger(s).");
                if (fingers == 1) {
                    ...
                    Intent back_to_graph_selector = new Intent(snowy_days.this, GraphSelector.class);
            ...
            public void run() {
                ...
                if (sfg.finger_count == 1){
                    ...
                    if (f0_index != -1) {
                        ...
                        // setting text to speech for snowy_days
                        if (X_screenPercent > 0.36 && X_screenPercent < 0.62 && Y_screenPercent < 0.07 && Y_screenPercent > 0.02){
                            if (!hasSpoken) {
                                tts.speak("Title: Number of Snowy Days! We documented the number of snowy days for six months in 2022. The bar graph presented below illustrates the distribution of snowy days across each month. Refer to the graph below to address the following questions.", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.01 && X_screenPercent < 0.04 && Y_screenPercent < 0.64 && Y_screenPercent > 0.33){
                            if (!hasSpoken) {
                                tts.speak("Y-axis title: Number of Days", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.49 && X_screenPercent < 0.57 && Y_screenPercent < 0.99 && Y_screenPercent > 0.95){
                            if (!hasSpoken) {
                                tts.speak("X-axis title: Months", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.12 && X_screenPercent < 0.19 && Y_screenPercent < 0.93 && Y_screenPercent > 0.89){
                            if (!hasSpoken) {
                                tts.speak("September", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.26 && X_screenPercent < 0.34 && Y_screenPercent < 0.93 && Y_screenPercent > 0.89){
                            if (!hasSpoken) {
                                tts.speak("October", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.42 && X_screenPercent < 0.49 && Y_screenPercent < 0.93 && Y_screenPercent > 0.89){
                            if (!hasSpoken) {
                                tts.speak("November", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.57 && X_screenPercent < 0.64 && Y_screenPercent < 0.93 && Y_screenPercent > 0.89){
                            if (!hasSpoken) {
                                tts.speak("December", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.72 && X_screenPercent < 0.79 && Y_screenPercent < 0.93 && Y_screenPercent > 0.89){
                            if (!hasSpoken) {
                                tts.speak("January", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.87 && X_screenPercent < 0.94 && Y_screenPercent < 0.93 && Y_screenPercent > 0.89){
                            if (!hasSpoken) {
                                tts.speak("February", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.04 && X_screenPercent < 0.98 && Y_screenPercent < 0.87 && Y_screenPercent > 0.85){
                            if (!hasSpoken) {
                                tts.speak("0", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.04 && X_screenPercent < 0.98 && Y_screenPercent < 0.80 && Y_screenPercent > 0.76){
                            if (!hasSpoken) {
                                tts.speak("2", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.04 && X_screenPercent < 0.98 && Y_screenPercent < 0.71 && Y_screenPercent > 0.68){
                            if (!hasSpoken) {
                                tts.speak("4", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.04 && X_screenPercent < 0.98 && Y_screenPercent < 0.63 && Y_screenPercent > 0.59){
                            if (!hasSpoken) {
                                tts.speak("6", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.04 && X_screenPercent < 0.98 && Y_screenPercent < 0.54 && Y_screenPercent > 0.51){
                            if (!hasSpoken) {
                                tts.speak("8", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.04 && X_screenPercent < 0.98 && Y_screenPercent < 0.46 && Y_screenPercent > 0.42){
                            if (!hasSpoken) {
                        ...
                        } else if (X_screenPercent > 0.04 && X_screenPercent < 0.98 && Y_screenPercent < 0.29 && Y_screenPercent > 0.25){
                            if (!hasSpoken) {
                                tts.speak("14", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.04 && X_screenPercent < 0.98 && Y_screenPercent < 0.20 && Y_screenPercent > 0.17){
                            if (!hasSpoken) {
                                tts.speak("16", TextToSpeech.QUEUE_FLUSH, null);
                                hasSpoken = true;
                            }
                        } else if (X_screenPercent > 0.04 && X_screenPercent < 0.98 && Y_screenPercent < 0.12 && Y_screenPercent > 0.08){
                            if (!hasSpoken) {
    ...
    public void logger(String file_name) throws IOException {
        ...
        final Runnable runnable = new Runnable() {
            ...
            public void run() {
                ...
                if (ContextCompat.checkSelfPermission(snowy_days.this,Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(snowy_days.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},1);
                }
                else {
